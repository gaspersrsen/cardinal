...
git submodule update --init --recursive contrib/nekRS
git submodule update --init --recursive contrib/openmc
git submodule update --init --recursive contrib/DAGMC
git submodule update --init --recursive contrib/moab
git submodule update --init --recursive test/tests/nek_ci
git submodule update --init --recursive contrib/double-down
git submodule update --init --recursive contrib/embree
